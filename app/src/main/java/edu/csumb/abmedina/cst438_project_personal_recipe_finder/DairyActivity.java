...
public class DairyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chewsButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(DairyActivity.this, DashboardActivity.class);
    ...
    protected void onStart() {
        ...
        databaseItems.orderByChild("itemType").equalTo("Dairy").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ItemList adapter = new ItemList(DairyActivity.this, itemList);
