...
public class OtherFoodActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        databaseItems.orderByChild("itemType").equalTo("Other").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ItemList adapter = new ItemList(OtherFoodActivity.this, itemList);
