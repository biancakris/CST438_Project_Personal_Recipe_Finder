...
public class FruitsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chewsButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(FruitsActivity.this, DashboardActivity.class);
    ...
    protected void onStart() {
        ...
        databaseItems.orderByChild("itemType").equalTo("Fruit").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ItemList adapter = new ItemList(FruitsActivity.this, itemList);
