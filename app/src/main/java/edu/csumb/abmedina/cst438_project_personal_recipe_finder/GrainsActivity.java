...
public class GrainsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chewsButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(GrainsActivity.this, DashboardActivity.class);
    ...
    protected void onStart() {
        ...
        databaseItems.orderByChild("itemType").equalTo("Grain").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ItemList adapter = new ItemList(GrainsActivity.this, itemList);
